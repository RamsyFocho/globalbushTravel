...
export async function GET() {
  try {
    ...
    console.log("=== DUFFEL API DEBUG TEST ===")
    ...
    console.log("Step 1: Sending offer request...")
    ...
    console.log("Step 1: Response status:", offerResponse.status)
    ...
    console.log("Step 1: Offer request ID:", offerRequestId)
